package com.volextierlist.tiertagger.config;
...
public class ModConfig {
    ...
    public static void load() {
        ...
        try (FileReader reader = new FileReader(configFile)) {
            ...
            VolexTierTagger.LOGGER.info("Config loaded successfully");
        } catch (Exception e) {
            VolexTierTagger.LOGGER.error("Failed to load config: {}", e.getMessage());
        }
    }
    ...
    public static void save() {
        try {
            ...
            VolexTierTagger.LOGGER.info("Config saved successfully");
        } catch (Exception e) {
            VolexTierTagger.LOGGER.error("Failed to save config: {}", e.getMessage());
        }
    }
